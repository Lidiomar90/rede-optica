...
Faça varredura do site inteiro, mas priorize os fluxos mais operacionais e moveis.
...
6. Se a publicacao atual parece segura ou se precisa trava extra antes de publicar.
...
7. Checklist curto de publicacao segura
...
# FORMATO
Use linguagem técnica clara, direta e objetiva.

# ROLE
Você é um agente de validação trabalhando com Codex e Claude.
...
Este checklist nao serve para “ficar bonito”.
...
- [ ] o clique no ativo nao exige “caçar” no mapa
...
- o mapa ainda esta mais proximo de “visualizacao” do que de ferramenta operacional
...
- GeoSite costuma parecer mais “clicavel” e mais navegavel nas linhas do que o mapa atual
...
- [ ] ponto A/B podem ser reatribuídos
...
- [ ] botões ficam grandes o suficiente
...
- o sistema ainda fica “desktop-first”, nao “field-first”
...
- [ ] auditoria nao gera falsa sensação de pronto
...
- [ ] navegação entre ativos relacionados
- [ ] ruptura com cabo lançado e nova caixa
- [ ] preset de campo
